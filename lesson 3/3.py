...
# DataFeame - двумерный массив с явно определёнными индексами. Последовательность согласованных по объектов Series
...
# data = pd.DataFrame({'area1': area, 'pop1': population, 'pop': population})
