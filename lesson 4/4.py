...
multi_index = pd.MultiIndex.from_tuples(index, names=['City', 'Year', 'ID'])
...
# pop_df1 = pop_df.loc???['city_1', 'something']
# pop_df1 = pop_df.loc???[['city_1', 'city_3'], ['total', 'something']]
# pop_df1 = pop_df.loc???[['city_1', 'city_3'], 'something']
...
# 4. описание внутреннего представления, levels - список списков, codes
...
i4 = pd.MultiIndex(
    ...
    codes=[
        [0, 0, 1, 1],  # первый уровень - 'a', 'a', 'b', 'b'
        [0, 1, 0, 1]  # второй уровень - 1 2 1 2
    ]
)
